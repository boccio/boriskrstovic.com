	...
	<div class="box pad-lg-35"><?php
		if(is_search()){ ?>
			<h1><?php _e('Nothing matched the search string: ', 'bluth'); ?><?php the_search_query(); ?></h1><?php
		}else{ ?>
			<h1><?php _e('404 - Page/Post not found', 'bluth'); ?></h1><?php
		} ?>
		<p class="lead text-muted"><?php _e('We could not find the page you were looking for.', 'bluth'); ?></p>
		<hr>
		<?php get_search_form(); ?> 
		<hr>
