					...
					<ul>
					    <?php
					        ...
					        <li> <?php 
					        	...
					        	$post_thumbnail = blu_get_post_image($post->ID, 'mini', false);
				        		if ( $post_thumbnail ){ 
					        	...
					        	echo '<div class="tab_text"><h5><a href="'. get_permalink().'">'.get_the_title().'</a></h5><small> <time class="entry-date" datetime="' . get_the_date( 'c' ) . '">' . get_the_date() . '</time></small></div>'; 
					        	?>
					        </li>
					        <?php endforeach; 
