	...
	function widget( $args, $instance ) {
		...
		<div class="widget-body">
			...
			$social_locale = array(
				...
				'google-plus' => array( 'suffix' => 'people', 'url' => 'https://plus.google.com/'),
			...
			foreach ($social_authority as $key => $value) { ?>
				<li class="<?php echo $key; ?>"><a href="<?php echo $social_locale[$key]['url'].$social_sites[$key]; ?>" target="_blank"><div class="bl_wrapper"><i class="fa fa-<?php echo $key; ?>"></i><h4><?php echo number_format($value, 0, ',','.'); ?></h4><small><?php echo $social_locale[$key]['suffix']; ?></small></div></a></li><?php
			} ?>
