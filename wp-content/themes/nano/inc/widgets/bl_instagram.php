  ...
  function widget($args, $instance){
	...
	if($title){
		...
		if($instance['show_icon']){
			$title = '<i class="fa fa-instagram"></i> '.$title;
		}
					...
					<div class="swiper-container swiper-container-instagram">
						...
						<div class="swiper-wrapper">
							...
							<div class="swiper-slide"> 
								<a href="<?php echo $post->link ?>#" style="background-image: url('<?php echo $post->images->low_resolution->url ?>')" target="_blank">
									<div class="instagram-interactions">
										<i class="fa fa-comment"></i>&nbsp;<?php echo $post->comments->count ?>
										<i class="fa fa-heart"></i>&nbsp;<?php echo $post->likes->count ?>
