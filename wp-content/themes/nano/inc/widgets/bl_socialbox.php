  ...
  function widget($args, $instance){
    ...
    ?>
    	...
    	<div class="widget-body">
    		<ul class="clearfix">
	    	<?php echo !empty($instance['facebook']) 	? '<li><a target="_blank" data-title="Facebook" class="tips bl_icon_facebook" href="'.$instance['facebook'].'"><i class="fa fa-facebook"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['twitter']) 	? '<li><a target="_blank" data-title="Twitter" class="tips bl_icon_twitter" href="'.$instance['twitter'].'"><i class="fa fa-twitter"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['googleplus']) 	? '<li><a target="_blank" data-title="Google+" class="tips bl_icon_googleplus" href="'.$instance['googleplus'].'"><i class="fa fa-google-plus"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['linkedin']) 	? '<li><a target="_blank" data-title="Linkedin" class="tips bl_icon_linkedin" href="'.$instance['linkedin'].'"><i class="fa fa-linkedin"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['youtube']) 	? '<li><a target="_blank" data-title="Youtube" class="tips bl_icon_youtube" href="'.$instance['youtube'].'"><i class="fa fa-youtube"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['rss']) 		? '<li><a target="_blank" data-title="Rss" class="tips bl_icon_rss" href="'.$instance['rss'].'"><i class="fa fa-rss"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['flickr']) 		? '<li><a target="_blank" data-title="Flickr" class="tips bl_icon_flickr" href="'.$instance['flickr'].'"><i class="fa fa-flickr"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['vimeo']) 		? '<li><a target="_blank" data-title="Vimeo" class="tips bl_icon_vimeo" href="'.$instance['vimeo'].'"><i class="fa fa-vimeo-square"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['pinterest']) 	? '<li><a target="_blank" data-title="Pinterest" class="tips bl_icon_pinterest" href="'.$instance['pinterest'].'"><i class="fa fa-pinterest"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['dribbble']) 	? '<li><a target="_blank" data-title="Dribbble" class="tips bl_icon_dribbble" href="'.$instance['dribbble'].'"><i class="fa fa-dribbble"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['tumblr']) 		? '<li><a target="_blank" data-title="Tumblr" class="tips bl_icon_tumblr" href="'.$instance['tumblr'].'"><i class="fa fa-tumblr"></i></a></li>' : '' ?>
	    	<?php echo !empty($instance['instagram']) 	? '<li><a target="_blank" data-title="Instagram" class="tips bl_icon_instagram" href="'.$instance['instagram'].'"><i class="fa fa-instagram"></i></a></li>' : '' ?>
    		</ul>
    	</div>
    <?php
	echo $after_widget;
