...
function loadStickySidebar(){
    // if we haven't already loaded the sidebar
    if(!sidebarloaded){
        ...
        if(jQuery('.sticky_sidebar').length > 0){
            imagesLoaded( document.querySelector('#side-bar'), function( instance ) {
                ...
                var stickyTop = jQuery('.sticky_sidebar').offset().top-offsetAdd;
                ...
                if(jQuery('.comments').length > 0){
                    ...
                    var stickyBottom = jQuery('.site-footer').height();
                }
                ...
                jQuery('body').append('<style>#side-bar .sticky_sidebar.affix-bottom{ bottom:' + stickyBottom + 'px }</style>');
